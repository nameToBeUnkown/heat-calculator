...
export default function App() {
  ...
  return (
    <>
          ...
          <div className="lg:col-span-3 space-y-8 bg-white p-6 sm:p-10 rounded-3xl shadow-[0_2px_20px_rgb(0,0,0,0.04)] border border-stone-100">
            <div>
              ...
              <p className="text-stone-500 text-sm">
                Введіть параметри для обчислення продуктивності та теплової
                потужності.
              </p>
            </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-light tracking-tight">
                      {results.volume > 0
                        ? Math.round(results.volume).toLocaleString("uk-UA")
                        : "0"}
                    </span>
                ...
                <div className="pt-4 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-stone-300">
                      {results.area > 0 ? results.area.toFixed(4) : "0"} м²
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-stone-500">Різниця температур:</span>
                    <span className="text-stone-300">
                      Δ {results.deltaT > 0 ? results.deltaT.toFixed(1) : "0"}{" "}
                      °C
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-orange-50/50 border border-orange-100 p-5 rounded-3xl text-sm text-stone-600 flex gap-3">
              ...
              <p className="leading-relaxed">
                Для точнішого результату заміряйте швидкість повітря у кількох
                точках отвору та введіть <strong>середнє значення</strong>.
              </p>
            </div>
          </div>
        </div>
      ...
      <PwaInstallBanner state={pwaInstall} />
    </>
  );
}
